...
// export function PolicySidebarR1({ className }: { className?: string }) {
...
//   return (
//     <div
//       className={cn("w-64 h-dvh border-r flex flex-col", className)}
//       // collapsible="icon"
//     >
...
//                 const fullPath = `/${enterpriseId}${policyListItems.url}?policyId=${policyId}`;
...
//                 const fullPath = `/${enterpriseId}${policyDetailItems.url}?policyId=${policyId}`;
//                 const isActive = pathname === fullPath;
...
//                 const fullPath = `/${enterpriseId}${scheduleDeliveryItems.url}`;
//                 const isActive = pathname === fullPath;

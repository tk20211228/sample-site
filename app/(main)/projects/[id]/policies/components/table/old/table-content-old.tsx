...
// interface PoliciesTableToolbarProps<TData extends PolicyTableType, TValue> {
//   table: Table<TData>;
//   columns: ColumnDef<TData, TValue>[];
// }

// export default function TableContent<TData extends PolicyTableType, TValue>({
//   table,
//   columns,
// }: PoliciesTableToolbarProps<TData, TValue>) {

          ...
          <SidebarGroupContent>
            <SidebarMenu>
              {deviceListItems.map((deviceListItems) => {
                const fullPath = `/projects/${enterpriseId}${deviceListItems.url}`;
          ...
          <SidebarGroupContent>
            <SidebarMenu>
              {lostModeItems.map((lostModeItems) => {
                const fullPath = `/projects/${enterpriseId}${lostModeItems.url}`;
                const isActive = pathname === fullPath;
          ...
          <SidebarGroupContent>
            <SidebarMenu>
              {zeroTouchItems.map((zeroTouchItems) => {
                const fullPath = `/projects/${enterpriseId}${zeroTouchItems.url}`;
                const isActive = pathname === fullPath;

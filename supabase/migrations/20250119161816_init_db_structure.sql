...
CREATE UNIQUE INDEX memory_events_pkey ON public.memory_events USING btree (enterprise_id, device_identifier);
...
CREATE UNIQUE INDEX power_management_events_pkey ON public.power_management_events USING btree (enterprise_id, device_identifier);
